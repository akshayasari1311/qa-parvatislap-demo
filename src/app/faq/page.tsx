...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "OPTION 1:\nYou can book a 4x4 cab up to 6 guests directly from Kasol to Lapas village. From Lapas Village it's a 30-45 min climb to our property. (Tourist speed)\n\nOPTION 2:\nTake a local bus till Balarga village which is about 25 mins. From here there is an off-road camper which can take up to 6 guests till Lapas Village in 15 mins and from Lapas Village it's a 30-45 min climb to our property. (Tourist speed)\n\nOPTION 3:\nTake a local bus to Shangna village and then trek up to our property for 2 hrs.",
  },
  {
